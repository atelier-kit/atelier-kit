...
## Commands vs native plan

- `/plan ...` — Use the host agent's **native** plan mode. Do **not** activate Atelier or create `.atelier/epics/`.
- `/atelier quick ...` — Atelier protocol, **quick** mode.
- `/atelier plan ...` — Atelier protocol, **standard** mode.
- `/atelier deep ...` — Atelier protocol, **deep** mode.
